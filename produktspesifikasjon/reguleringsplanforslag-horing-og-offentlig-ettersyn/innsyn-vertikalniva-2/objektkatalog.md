...
**Kilde:** [OGC API - Features](https://nap.ft.dibk.no/services/rest/reguleringsplanforslag/vn2)





<a href="innsyn-vertikalniva-2_feature_catalogue.png" title="Klikk for stor visning"><img src="innsyn-vertikalniva-2_feature_catalogue.png" alt="Datamodell Innsyn vertikalnivå 2" style="max-width: 100%; height: auto;" /></a>
...
Avgrensingsobjekt for områder for regulerings- og bebyggelsesplan/områderegulering, eller detaljregulering
...
Avgrensingsobjekt for formålsområde (RpArealformålOmråde)
...
Avgrensingsobjekt for bestemmelsesområder for midlertidig bygg og anlegg (PblMidlByggAnleggOmråde)
...
Avgrensingsobjekt for områder for hensynssone, angitt hensyn (RpAngittHensynSone)
...
Avgrensingsobjekt for områder for hensynssone, båndlegging (RpBåndleggingSone)
...
Avgrensingsobjekt for områder for hensynssone, detaljering (RpDetaljeringSone)
...
Avgrensingsobjekt for områder for hensynssone, fare (RpFareSone)
...
Avgrensingsobjekt for områder for hensynssone, gjennomføring (RpGjennomføringSone)
...
Avgrensingsobjekt for områder for hensynssone, infrastruktur (RpInfrastrukturSone)
...
Avgrensingsobjekt for områder for hensynssone, sikring (RpSikringSone)
...
Avgrensingsobjekt for områder for hensynssone, støy (RpStøySone)
...
Avgrensingsobjekt for områder for bestemmelse (RpBestemmelseOmråde)
...
<table class="feature-attribute-table">
  ...
  <tbody>
    <tr>
      <th scope="row">Navn:</th>
      <td><strong>rotasjon_25832</strong></td>
    </tr>
    <tr>
      <th scope="row">Definisjon:</th>
      <td>rotasjon_25832</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>0..1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    <tr>
      <th scope="row">Navn:</th>
      <td><strong>rotasjon_25835</strong></td>
    </tr>
    <tr>
      <th scope="row">Definisjon:</th>
      <td>rotasjon_25835</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>0..1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    <tr>
      <th scope="row">Navn:</th>
      <td><strong>rotasjon_3857</strong></td>
    </tr>
    <tr>
      <th scope="row">Definisjon:</th>
      <td>rotasjon_3857</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Definisjon:</th>
      <td>reguleringsformålsutdyping</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>0..1</td>
...
Avgrensingsobjekt for områder for bevaring (RbBevaringOmråde)
...
Avgrensingsobjekt for områder for fornyelse (RbFornyelseOmråde)
...
Avgrensingsobjekt for områder med formålsrekkefølge (RbRekkefølgeOmråde)
...
Avgrensingsobjekt for områder med restriksjon (RbRestriksjonOmråde)
