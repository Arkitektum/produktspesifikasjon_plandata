...
### Datamodell - Kommuneplaner



<a href="kommuneplaner/kommuneplaner_feature_catalogue.png" title="Klikk for stor visning"><img src="kommuneplaner/kommuneplaner_feature_catalogue.png" alt="Datamodell Kommuneplaner" style="max-width: 100%; height: auto;" /></a>



➡️ [Se full datamodell for omfang "Kommuneplaner" (diagram per pakke og objektkatalog)](kommuneplaner/objektkatalog.html)

### Datamodell - Kommunedelplaner



<a href="kommunedelplaner/kommunedelplaner_feature_catalogue.png" title="Klikk for stor visning"><img src="kommunedelplaner/kommunedelplaner_feature_catalogue.png" alt="Datamodell Kommunedelplaner" style="max-width: 100%; height: auto;" /></a>



➡️ [Se full datamodell for omfang "Kommunedelplaner" (diagram per pakke og objektkatalog)](kommunedelplaner/objektkatalog.html)
...
| --- | --- | --- | --- | --- |
| WMS-tjeneste | [Lenke](https://nap.ft.dibk.no/services/wms/kommuneplaner/?service=WMS&request=GetCapabilities) | OGC:WMS | PNG | landsfiler |
| OGC API-Features | [Lenke](https://nap.ft.dibk.no/services/rest/kommuneplaner/) | OGC:API-Features | GeoJSON | landsfiler |
| OGC API-Features | [Lenke](https://nap.ft.dibk.no/services/rest/kommunedelplaner) | OGC:API-Features | GeoJSON | landsfiler |
| Atom Feed | [Lenke](https://nap.ft.dibk.no/services/download/kommuneplaner/atom) | W3C:AtomFeed | PostGIS | landsfiler |
| Atom Feed | [Lenke](https://nap.ft.dibk.no/services/download/kommunedelplaner/atom) | W3C:AtomFeed | PostGIS | landsfiler |
