...
# Produktspesifikasjon: FKB-Bygning

*FKB-Bygning er en del av Felles Kartdatabase (FKB). FKB er en samling datasett som utgjør en sentral del av grunnkartet. Se metadataoppføring for Felles Kartdatabase for mer info.
...
**Nøkkelord:** FKB, Basisdata, Grunnkart, Bygning, Bygg, Norge, Nasjonalt, Bygninger, geodataloven, Norge digitalt, beredskapsbase, Det offentlige kartgrunnlaget, modellbaserteVegprosjekter, fellesDatakatalog, Basis geodata
...
- **Kvalitetsmål**: SOSI-produktspesifikasjon: FKB Bygning
...
| Atom Feed | [Lenke](http://nedlasting.geonorge.no/geonorge/ATOM-feeds/FKB-Bygning_AtomFeedFGDB.xml) | W3C:AtomFeed | FGDB | fylkesvis, kommunevis, landsfiler |
| Atom Feed | [Lenke](http://nedlasting.geonorge.no/geonorge/ATOM-feeds/FKB-Bygning_AtomFeedGML.xml) | W3C:AtomFeed | GML | fylkesvis, kommunevis, landsfiler |
| Atom Feed | [Lenke](http://nedlasting.geonorge.no/geonorge/ATOM-feeds/FKB-Bygning_AtomFeedSOSI.xml) | W3C:AtomFeed | SOSI | fylkesvis, kommunevis, landsfiler |
